...
import com.fcesur.cs.cookie.CookieVsUserID;
...
import com.fcesur.cs.netty.channels.ChannelsMap;
...
public final class WebSocketHandler extends SimpleChannelInboundHandler<Object> {
     ...
     */
    public WebSocketHandler(@NonNull MessageDigester messageDigester, @NonNull JacksonObjectWrapper jacksonObjectWrapper) {
