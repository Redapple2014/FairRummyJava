...
import org.fcesur.skillengine.rummy.game.GameStateChanges;
import org.fcesur.skillengine.rummy.game.RummyGame;
import org.fcesur.skillengine.rummy.game.UserHandInfo;
...
import org.fcesur.skillengine.rummy.globals.VariantTypes;
import org.fcesur.skillengine.rummy.message.BoardMessage;
import org.fcesur.skillengine.rummy.message.BoardStatus;
import org.fcesur.skillengine.rummy.message.Converter;
...
import org.fcesur.skillengine.rummy.message.Seats;
import org.fcesur.skillengine.rummy.message.UpdateSeatBalance;
import org.fcesur.skillengine.rummy.player.PlayerInfo;
import org.fcesur.skillengine.rummy.player.SeatPlayerInfo;
import org.fcesur.skillengine.rummy.settlement.PointsSettlement;
...
public class RummyBoard extends Board {
    ...
    public void checkWhetherPlayerIsAlready(long playerId) {
        try {
            ...
            BoardMessage boardInfo = new BoardMessage(getGameTemplates().getMaxPlayer(), getGameTemplates().getMinBuyin(), getGameTemplates().getMaxBuyin(), getTableId(),
