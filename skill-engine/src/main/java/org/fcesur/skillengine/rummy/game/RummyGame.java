...
import org.fcesur.skillengine.rummy.cards.CardId;
import org.fcesur.skillengine.rummy.globals.PlayerKickOutState;
import org.fcesur.skillengine.rummy.globals.ResultantGameTypes;
import org.fcesur.skillengine.rummy.globals.TimeTaskTypes;
import org.fcesur.skillengine.rummy.message.DealWinner;
import org.fcesur.skillengine.rummy.message.Declare;
import org.fcesur.skillengine.rummy.message.DeclareEvent;
import org.fcesur.skillengine.rummy.message.DeclareEventTimeOut;
import org.fcesur.skillengine.rummy.message.DisCardOutBound;
import org.fcesur.skillengine.rummy.message.Discard;
import org.fcesur.skillengine.rummy.message.Drop;
import org.fcesur.skillengine.rummy.message.DropResponse;
import org.fcesur.skillengine.rummy.message.Finish;
import org.fcesur.skillengine.rummy.message.FinishInited;
import org.fcesur.skillengine.rummy.message.FinishPlayerTimeOut;
import org.fcesur.skillengine.rummy.message.GameSetup;
import org.fcesur.skillengine.rummy.message.GameStatus;
import org.fcesur.skillengine.rummy.message.GameToss;
import org.fcesur.skillengine.rummy.message.HandDiscardInfo;
import org.fcesur.skillengine.rummy.message.Message;
import org.fcesur.skillengine.rummy.message.PickCloseDeckOutBound;
import org.fcesur.skillengine.rummy.message.PickClosedDeck;
import org.fcesur.skillengine.rummy.message.PickOpenDeck;
import org.fcesur.skillengine.rummy.message.PickOpenDeckOutBound;
import org.fcesur.skillengine.rummy.message.PlayerBootedOut;
import org.fcesur.skillengine.rummy.message.PlayerDeclaringDetails;
import org.fcesur.skillengine.rummy.message.PlayerDeclaringState;
import org.fcesur.skillengine.rummy.message.PlayerSequence;
import org.fcesur.skillengine.rummy.message.PlayerTurnIntimation;
import org.fcesur.skillengine.rummy.message.PlayerTurnTimeOut;
import org.fcesur.skillengine.rummy.message.ResetCards;
import org.fcesur.skillengine.rummy.message.ReshuffleCards;
import org.fcesur.skillengine.rummy.message.ScoreUpdate;
import org.fcesur.skillengine.rummy.message.TossInfo;
import org.fcesur.skillengine.rummy.message.UserScore;
import org.fcesur.skillengine.rummy.message.WrongFinishInfo;
import org.fcesur.skillengine.rummy.player.PlayerInfo;
import org.fcesur.skillengine.rummy.score.RummyGameScore;
import org.fcesur.skillengine.rummy.table.RummyBoard;
import org.fcesur.skillengine.rummy.table.TableTimerTask;
...
public class RummyGame extends TrickTakingGame {
    ...
    public boolean discard(Discard discard, long userId) {
        boolean succ = false;
        long playerId = userId;
        long currentPlayer = 0;
        if (endGame.get()) {
